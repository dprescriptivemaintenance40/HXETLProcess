...
#ScrewParamter
query='''SELECT * FROM HXCleaningTablesIncipient WHERE HXId={}'''
...
for i, row in c.iterrows():
  if pd.isnull(row['HXId']):
        ...
        batch=int(row['HXId'])
  SQLCommand = "INSERT INTO HXProcessedTables(HXId,Date,TT1,TT2,TS1,TS2,ShellDiffTemp,FT1,FT2,PT1,PT2,PS1,PS2,Mass,SpecificHeat,HTC,HeatEnergy,LMTD,Area,Incipient,Degrade) VALUES('" + str(row['HXId']) + "','" + str(row['Date']) + "','" + str(row['TT1']) + "','" + str(row['TT2']) + "','" + str(row['TS1']) + "','" + str(row['TS2']) + "','" + str(row['ShellDiffTemp']) + "','" + str(row['FT1']) + "','" + str(row['FT2']) + "','" + str(row['PT1']) + "','" + str(row['PT2']) + "','" + str(row['PS1']) + "','" + str(row['PS2']) + "','" + str(row['Mass']) + "','" + str(row['SpecificHeat']) + "','" + str(row['HTC']) + "','" + str(row['HeatEnergy']) + "','" + str(row['LMTD']) + "','" + str(row['Area']) + "','" + str(row['Incipient']) + "','" + str(row['Degrade']) + "')"
